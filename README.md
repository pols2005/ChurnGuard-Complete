...
- [X] ![Static Badge](https://img.shields.io/badge/Customer%20Churn%20Prediction-purple) Predict churn probabilities using ML models.
- [X] ![Static Badge](https://img.shields.io/badge/Actionable%20Insights-purple) Detailed explanations of why a customer is at risk of churning, powered by Google’s Gemma2.
- [X] ![Static Badge](https://img.shields.io/badge/Personalized%20Retention%20Strategies-purple) Automatically generate customer-specific emails to incentivize loyalty.
- [X] ![Static Badge](https://img.shields.io/badge/Dynamic%20Dashboards-purple) Interactive visualizations including:
...
1. ![Static Badge](https://img.shields.io/badge/Dataset-red) 
   - Bank customer dataset from Kaggle.

2. ![Static Badge](https://img.shields.io/badge/Data%20Splitting-red) 
   - The dataset was split into 80/20 ratio (80% for training and 20% for testing)

3. ![Static Badge](https://img.shields.io/badge/Feature%20Engineering-red)  
...
4. ![Static Badge](https://img.shields.io/badge/Models%20Trained-red) 
   - XGBoost  
   - k-Nearest Neighbors  
   - Gradient Boosting  
   - ExtraTrees  
...
5. ![Static Badge](https://img.shields.io/badge/Ensembling%20Techniques-red)
...
6. ![Static Badge](https://img.shields.io/badge/Performance%20Metrics-red)  
   - **Accuracy**: 0.851500  
   - **Recall**: 0.62
